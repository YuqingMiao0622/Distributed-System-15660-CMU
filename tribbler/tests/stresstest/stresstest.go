...
//	debug = true
	...
	for _, cmd := range cmds {
		switch cmd {
		case GetFriends:
//			LOGE.Printf("MAIN:: Client: %s s GetFriends requested.\n", clientId)
...
//			LOGE.Printf("MAIN:: Client: %s s GetFriends completed.\n", clientId)
		case AddSubscription:
//			LOGE.Printf("MAIN:: Client: %s s AddSubscription requested.\n", clientId)
		...
		case RemoveSubscription:
//			LOGE.Printf("MAIN:: Client: %s s RemoveSubscription requested.\n", clientId)
			target := rand.Intn(numTargets)
		...
		case GetTribbles:
//			LOGE.Printf("MAIN:: Client: %s s GetTribbles requested.\n", clientId)
			target := rand.Intn(numTargets)
		...
		case PostTribble:
//			LOGE.Printf("MAIN:: Client: %s s PostTribble requested.\n", clientId)
			...
			tribIndex++
		case GetTribblesBySubscription:
//			LOGE.Printf("MAIN:: Client: %s s GetTribblesBySubscription requested.\n", clientId)
...
//	LOGE.Println("validateTribbles completed")
	return true
}
